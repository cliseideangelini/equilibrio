...
export default function PatientRegisterPage() {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            // Provide a dummy date of birth and use phone as username as they are required by the action
    ...
    return (
        <div className="min-h-screen bg-[#FDFCFB] flex flex-col items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full -z-10 overflow-hidden pointer-events-none">
                <div className="absolute top-[-10%] left-[-5%] w-96 h-96 bg-[#94A694]/20 rounded-full blur-[100px]" />
                <div className="absolute bottom-[-10%] right-[-5%] w-96 h-96 bg-[#F2E8DF]/40 rounded-full blur-[100px]" />
            </div>
            ...
            <div className="max-w-md w-full animate-in fade-in slide-in-from-bottom-8 duration-1000">
                <div className="bg-white rounded-[3rem] p-10 shadow-2xl shadow-stone-200/30 border border-stone-50">
                    <div className="text-center mb-10">
                        <div className="w-16 h-16 bg-[#94A694]/10 text-[#94A694] rounded-2xl flex items-center justify-center mx-auto mb-4">
                            <UserPlus size={32} />
                        </div>
                        <h1 className="text-3xl font-serif italic text-stone-800 mb-3">Criar Conta</h1>
                        <p className="text-[10px] font-black uppercase tracking-[0.2em] text-stone-400">Portal do Paciente</p>
                    </div>
                    ...
                    <form onSubmit={handleRegister} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-black uppercase tracking-widest text-stone-400 ml-1">Criar Senha</label>
                            <div className="relative">
